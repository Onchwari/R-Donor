    ...
    <table class="table-auto rounded-md">
        ...
        @foreach($user as $user)
            <tr class="border-b odd:bg-white even:bg-gray-50">
                ...
                <td class="px-6 py-4 "><a href="{{url('admin/edit/'.$user->id)}}"><button class="bg-orange-600 hover:border-2 hover:border-red-700 text-white py-1 px-4 rounded-md"
                       >Edit</button></a> </td>    
            <!-- <div>
    ...
    closeModal.forEach(close => {
        close.addEventListener('click', function (){
            modal.classList.add('hidden')
                ...
                <td class="px-6 py-4 "><a href="{{url('admin/blooddrives/delete/'.$user->id)}}"><button class="bg-orange-600 hover:border-2 hover:border-red-700 text-white py-1 px-4 rounded-md"
                       >Delete</button></a> </td>
